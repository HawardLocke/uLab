...
namespace Lite.BevTree
{
	...
	public class Blackboard
	{
		...
		public void SetLong(long treeId, long nodeId, string key, long value)
		{
			...
			if (m_nodeLongDic.ContainsKey(treeId))
			{
				sdic = m_nodeLongDic[treeId];
			}
			else
			{
