...
public static class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(Lite.ui.UIEventListener.VoidDelegate), Lite_ui_UIEventListener_VoidDelegate);
	...
	class Lite_ui_UIEventListener_VoidDelegate_Event : LuaDelegate
	{
		public Lite_ui_UIEventListener_VoidDelegate_Event(LuaFunction func) : base(func) { }
		public Lite_ui_UIEventListener_VoidDelegate_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public static Delegate Lite_ui_UIEventListener_VoidDelegate(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			Lite.ui.UIEventListener.VoidDelegate fn = delegate(UnityEngine.GameObject param0) { };
			return fn;
		}

		if(!flag)
		{
			Lite_ui_UIEventListener_VoidDelegate_Event target = new Lite_ui_UIEventListener_VoidDelegate_Event(func);
			Lite.ui.UIEventListener.VoidDelegate d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			Lite_ui_UIEventListener_VoidDelegate_Event target = new Lite_ui_UIEventListener_VoidDelegate_Event(func, self);
			Lite.ui.UIEventListener.VoidDelegate d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}
